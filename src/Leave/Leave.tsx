    ...
    <div className="leave">
      ...
      <div className="leave__readbox">
        ...
        <p className="leave__readbox__content-1">
          ...
          않습니다. <br />삭제되는 내용을 확인하시고 필요한 데이터는 미리 백업을
          해주세요.
        </p>
        ...
        <p className="leave__readbox__content-2">
          ...
          삭제를 원하는 게시글이 있다면 반드시 탈퇴 전 삭제하시기 바랍니다.<br /> 탈퇴
          후에는 회원정보가 삭제되어 본인 여부를 확인할 수 있는 방법이 없어,<br />
          게시글을 임의로 삭제해드릴 수 없습니다.
        </p>
      </div>
      <p className="leave__content-3">
        탈퇴 후에는다시 가입할 수 없으며 아이디와 데이터는 복구할 수 없습니다.<br />
